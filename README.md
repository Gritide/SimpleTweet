...
- [x]User can **compose and post a new tweet**
  - [x]ser can click a “Compose” icon in the Action Bar on the top right
  - [x] can then enter a new tweet and post this to twitter
...
I tried to do "User can **open the twitter app offline and see last loaded tweets**. Persisted in SQLite tweets are refreshed on every application launch. While "live data" is displayed when app can get it from Twitter API, it is also saved for use in offline mode" didnt work. I had an issue to push to the github as well but i fixed that issue.
